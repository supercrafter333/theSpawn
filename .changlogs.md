...
- *[CHANGE]* - Added class [`Warp`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/warp/Warp.php) and removed class `WarpInfo` (The `Warp`-class doesn't contain all methods of the old `WarpInfo`-class)
- *[CHANGE]* - Added class [`Home`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/home/Home.php) and removed class `HomeInfo` (The `Home`-class doesn't contain all methods of the old `HomeInfo`-class)
...
- *[API]* - The following classes have been added:
  - [`LocationHelper`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/LocationHelper.php)
  - [`WarpManager`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/warp/WarpManager.php)
  - [`Warp`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/warp/Warp.php)
  - [`HomeManager`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/home/HomeManager.php)
  - [`Home`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/home/Home.php)
  - [`LocationHelper`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/LocationHelper.php)
  - [`AliasManager`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/commands/alias/AliasManager.php)
  - [`AliasCommand`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/commands/alias/AliasCommand.php)
  - [`TpaManager`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/tpa/TpaManager.php)
  - [Event-Classes](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events)
    - [`EditHomeEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/other/EditHomeEvent.php)
    - [`EditWarpEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/other/EditWarpEvent.php)
    - [`RemoveHomeEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/other/RemoveHomeEvent.php)
    - [`RemoveHubEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/other/RemoveHubEvent.php)
    - [`RemoveWarpEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/other/RemoveWarpEvent.php)
    - [`SetHomeEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/position/SetHomeEvent.php)
    - [`SetHubEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/position/SetHubEvent.php)
    - [`SetWarpEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/position/SetWarpEvent.php)
    - [`HomeTeleportEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/teleport/HomeTeleportEvent.php)
    - [`HubTeleportEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/teleport/HubTeleportEvent.php)
    - [`SpawnTeleportEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/teleport/SpawnTeleportEvent.php)
    - [`WarpTeleportEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/teleport/WarpTeleportEvent.php)
    - [`RemoveSpawnEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/world/RemoveSpawnEvent.php)
    - [`SetSpawnEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/world/SetSpawnEvent.php)
    - [`theSpawnPlayerTeleportEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/theSpawnPlayerTeleportEvent.php)
    - [`theSpawnPositionEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/theSpawnPositionEvent.php)
    - [`theSpawnWorldEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/theSpawnWorldEvent.php)
...
- *[API]* - All hub methods was moved to [`HubManager`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/HubManager.php)
...
- *[API]* - added the following classes:
  - [`HubManager`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/HubManager.php)
...
- *[API]* - The following classes have been added:
  - [`AliasForms`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/form/AliasForms.php)
  - [`AliasesCommand`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/commands/alias/AliasesCommand.php)
...
- *[API]* - Created two new constants in [`theSpawn.php`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/theSpawn.php):
  - `MIN_PHP_VERSION` - theSpawn's minimum php version
  - `MIN_CONFIG_VERSION` - theSpawn's minimum config(.yml) version
- *[API]* - The following classes have been added:
  - [`PlayerWarpCommand`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/commands/PlayerWarpCommand.php)
  - [`PlayerWarpManager`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/pwarp/PlayerWarpManager.php)
  - [`PlayerWarp`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/pwarp/PlayerWarp.php)
  - [`theSpawnTpaEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/theSpawnTpaEvent.php)
  - [`TpaAnswerEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/tpa/TpaAnswerEvent.php)
  - [`TpaSendEvent`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/events/tpa/TpaSendEvent.php)
  - [`LastDeathPositionManager`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/LastDeathPositionManager.php)
- *[API]* - Removed the following methods from [`theSpawn.php`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/theSpawn.php):
...
- *[API]* - added new method [`HubManager::isHubWorld()`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/HubManager.php#L158) to check if a world is used as a hub
- *[API]* - The following classes have been added:
  - [`SpawnDelayManager`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/SpawnDelayManager.php)
  - [`ConfigManager`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/ConfigManager.php)
  - [`PlayerWarpForms`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/form/PlayerWarpForms.php)
- *[API]* - Removed the following methods from [`theSpawn.php`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/theSpawn.php):
...
- *[API]* - The following methods was moved to [`ConfigManager.php`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/ConfigManager.php) and does no longer exist in [`theSpawn.php`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/theSpawn.php):
  - `useAliases()`
  - `useHomes()`
...
- *[API]* - removed ` public Config $msgCfg` from [`theSpawn.php`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/theSpawn.php)
