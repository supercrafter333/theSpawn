...
- *[API]* - The following classes have been added:
  ...
  - [`AliasesCommand`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/command/alias/AliasesCommand.php)
...
- *[API]* - some variables are nor `readonly`
...
- *[API]* - The following classes have been added:
  - [`PlayerWarpCommand`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/command/PlayerWarpCommand.php)
...
- *[API]* - Removed the following methods form [`theSpawn.php`](https://github.com/supercrafter333/theSpawn/blob/PM5-development/src/theSpawn.php):
